...
parser.add_argument('-loss_name', type=str, default='huber_loss')
...
parser.add_argument('-lr', type=float, default=0.5e-5)
parser.add_argument('-epochs', type=int, default=15)
parser.add_argument('-num_layers_to_reinit', type=int, default=4)
